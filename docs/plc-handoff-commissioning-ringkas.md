...
| 4 | **IP address coupler dan nyambung ke switch/NIC yang mana.** NIC komputer sudah kepakai tiga kamera GigE | **Paling menghambat.** Aplikasi tidak bisa nyambung sama sekali |
