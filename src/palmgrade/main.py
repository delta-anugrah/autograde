...
def create_app() -> FastAPI:
    ...
    async def lifespan(app: FastAPI):
        ...
        try:
            camera.connect(index=settings.camera_device_index, serial=settings.camera_serial)
        ...
        capture_worker = FrameCaptureWorker(camera=camera, state=state, target_fps=settings.camera_fps, device_index=settings.camera_device_index, serial=settings.camera_serial)
