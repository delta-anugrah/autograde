...
class FrameCaptureWorker:
    def __init__(self, camera: CameraSource, state: RuntimeState, target_fps: int = 24, device_index: int = 0, serial: str | None = None, **_) -> None:
        self.camera = camera
        self.state = state
    ...
    def _try_reconnect(self) -> None:
        ...
        try:
            self.camera.connect(index=self._device_index, serial=self._serial)
